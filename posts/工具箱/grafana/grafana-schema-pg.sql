...
\restrict SbeG2HljRLjfkXQZs9XV4WpiYGqHmKMBsaJqW7wAVkbVsCbK5fHDvp0JSP4jdPN
...
ALTER TABLE public.alert_configuration_history_id_seq OWNER TO grafana;
...
ALTER TABLE public.alert_configuration_id_seq OWNER TO grafana;
...
ALTER TABLE public.alert_id_seq OWNER TO grafana;
...
ALTER TABLE public.alert_image_id_seq OWNER TO grafana;
...
ALTER TABLE public.alert_notification_id_seq OWNER TO grafana;
...
ALTER TABLE public.alert_notification_state_id_seq OWNER TO grafana;
...
ALTER TABLE public.alert_rule_id_seq OWNER TO grafana;
...
--
-- Name: alert_rule_state; Type: TABLE; Schema: public; Owner: grafana
--
...
ALTER TABLE public.alert_rule_state OWNER TO grafana;

--
-- Name: alert_rule_state_id_seq; Type: SEQUENCE; Schema: public; Owner: grafana
--
...
ALTER TABLE public.alert_rule_state_id_seq OWNER TO grafana;

--
-- Name: alert_rule_state_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: grafana
--
...
ALTER TABLE public.alert_rule_tag_id_seq OWNER TO grafana;
...
ALTER TABLE public.alert_rule_version_id_seq OWNER TO grafana;
...
ALTER TABLE public.annotation_id_seq OWNER TO grafana;
...
ALTER TABLE public.annotation_tag_id_seq OWNER TO grafana;
...
ALTER TABLE public.anon_device_id_seq OWNER TO grafana;
...
ALTER TABLE public.api_key_id_seq1 OWNER TO grafana;
...
ALTER TABLE public.builtin_role_id_seq OWNER TO grafana;
...
--
-- Name: cloud_migration_resource; Type: TABLE; Schema: public; Owner: grafana
--
...
ALTER TABLE public.cloud_migration_resource OWNER TO grafana;
...
ALTER TABLE public.cloud_migration_resource_id_seq OWNER TO grafana;
...
--
-- Name: cloud_migration_session; Type: TABLE; Schema: public; Owner: grafana
--
...
ALTER TABLE public.cloud_migration_session OWNER TO grafana;
...
ALTER TABLE public.cloud_migration_session_id_seq OWNER TO grafana;
...
--
-- Name: cloud_migration_snapshot; Type: TABLE; Schema: public; Owner: grafana
--
...
ALTER TABLE public.cloud_migration_snapshot OWNER TO grafana;
...
ALTER TABLE public.cloud_migration_snapshot_id_seq OWNER TO grafana;
...
ALTER TABLE public.dashboard_acl_id_seq OWNER TO grafana;
...
ALTER TABLE public.dashboard_id_seq1 OWNER TO grafana;
...
ALTER TABLE public.dashboard_provisioning_id_seq1 OWNER TO grafana;
...
ALTER TABLE public.dashboard_snapshot_id_seq OWNER TO grafana;
...
ALTER TABLE public.dashboard_tag_id_seq OWNER TO grafana;
...
ALTER TABLE public.dashboard_version_id_seq OWNER TO grafana;
...
ALTER TABLE public.data_source_id_seq1 OWNER TO grafana;
...
ALTER TABLE public.entity_event_id_seq OWNER TO grafana;
...
ALTER TABLE public.folder_id_seq OWNER TO grafana;
...
ALTER TABLE public.kv_store_id_seq OWNER TO grafana;
...
ALTER TABLE public.library_element_connection_id_seq OWNER TO grafana;
...
ALTER TABLE public.library_element_id_seq OWNER TO grafana;
...
ALTER TABLE public.login_attempt_id_seq1 OWNER TO grafana;
...
ALTER TABLE public.migration_log_id_seq OWNER TO grafana;
...
ALTER TABLE public.ngalert_configuration_id_seq OWNER TO grafana;
...
ALTER TABLE public.org_id_seq OWNER TO grafana;
...
ALTER TABLE public.org_user_id_seq OWNER TO grafana;
...
ALTER TABLE public.permission_id_seq OWNER TO grafana;
...
ALTER TABLE public.playlist_id_seq OWNER TO grafana;
...
ALTER TABLE public.playlist_item_id_seq OWNER TO grafana;
...
ALTER TABLE public.plugin_setting_id_seq OWNER TO grafana;
...
ALTER TABLE public.preferences_id_seq OWNER TO grafana;
...
ALTER TABLE public.provenance_type_id_seq OWNER TO grafana;
...
--
-- Name: query_history_details; Type: TABLE; Schema: public; Owner: grafana
--
...
ALTER TABLE public.query_history_details OWNER TO grafana;
...
ALTER TABLE public.query_history_details_id_seq OWNER TO grafana;
...
ALTER TABLE public.query_history_id_seq OWNER TO grafana;
...
ALTER TABLE public.query_history_star_id_seq OWNER TO grafana;
...
ALTER TABLE public.quota_id_seq OWNER TO grafana;
...
--
-- Name: resource; Type: TABLE; Schema: public; Owner: grafana
--
...
ALTER TABLE public.resource OWNER TO grafana;

--
-- Name: resource_blob; Type: TABLE; Schema: public; Owner: grafana
--
...
ALTER TABLE public.resource_blob OWNER TO grafana;

--
-- Name: resource_history; Type: TABLE; Schema: public; Owner: grafana
--
...
ALTER TABLE public.resource_history OWNER TO grafana;

--
-- Name: resource_migration_log; Type: TABLE; Schema: public; Owner: grafana
--
...
ALTER TABLE public.resource_migration_log OWNER TO grafana;

--
-- Name: resource_migration_log_id_seq; Type: SEQUENCE; Schema: public; Owner: grafana
--
...
ALTER TABLE public.resource_migration_log_id_seq OWNER TO grafana;

--
-- Name: resource_migration_log_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: grafana
--
...
--
-- Name: resource_version; Type: TABLE; Schema: public; Owner: grafana
--
...
ALTER TABLE public.resource_version OWNER TO grafana;
...
ALTER TABLE public.role_id_seq OWNER TO grafana;
...
ALTER TABLE public.secrets_id_seq OWNER TO grafana;
...
ALTER TABLE public.seed_assignment_id_seq OWNER TO grafana;
...
ALTER TABLE public.server_lock_id_seq OWNER TO grafana;
...
ALTER TABLE public.short_url_id_seq OWNER TO grafana;
...
ALTER TABLE public.signing_key_id_seq OWNER TO grafana;
...
ALTER TABLE public.star_id_seq OWNER TO grafana;
...
ALTER TABLE public.tag_id_seq OWNER TO grafana;
...
ALTER TABLE public.team_id_seq OWNER TO grafana;
...
ALTER TABLE public.team_member_id_seq OWNER TO grafana;
...
ALTER TABLE public.team_role_id_seq OWNER TO grafana;
...
ALTER TABLE public.temp_user_id_seq1 OWNER TO grafana;
...
ALTER TABLE public.test_data_id_seq OWNER TO grafana;
...
ALTER TABLE public.user_auth_id_seq OWNER TO grafana;
...
ALTER TABLE public.user_auth_token_id_seq OWNER TO grafana;
...
--
-- Name: user_external_session; Type: TABLE; Schema: public; Owner: grafana
--
...
ALTER TABLE public.user_external_session OWNER TO grafana;
...
ALTER TABLE public.user_external_session_id_seq OWNER TO grafana;
...
ALTER TABLE public.user_id_seq1 OWNER TO grafana;
...
ALTER TABLE public.user_role_id_seq OWNER TO grafana;
...
--
-- Name: alert_rule_state id; Type: DEFAULT; Schema: public; Owner: grafana
--
...
--
-- Name: cloud_migration_resource id; Type: DEFAULT; Schema: public; Owner: grafana
--
...
--
-- Name: cloud_migration_session id; Type: DEFAULT; Schema: public; Owner: grafana
--
...
--
-- Name: cloud_migration_snapshot id; Type: DEFAULT; Schema: public; Owner: grafana
--
...
--
-- Name: query_history_details id; Type: DEFAULT; Schema: public; Owner: grafana
--
...
--
-- Name: resource_migration_log id; Type: DEFAULT; Schema: public; Owner: grafana
--
...
--
-- Name: user_external_session id; Type: DEFAULT; Schema: public; Owner: grafana
--
...
--
-- Name: alert_rule_state alert_rule_state_pkey; Type: CONSTRAINT; Schema: public; Owner: grafana
--
...
--
-- Name: cloud_migration_resource cloud_migration_resource_pkey; Type: CONSTRAINT; Schema: public; Owner: grafana
--
...
--
-- Name: cloud_migration_session cloud_migration_session_pkey; Type: CONSTRAINT; Schema: public; Owner: grafana
--
...
--
-- Name: cloud_migration_snapshot cloud_migration_snapshot_pkey; Type: CONSTRAINT; Schema: public; Owner: grafana
--
...
--
-- Name: query_history_details query_history_details_pkey; Type: CONSTRAINT; Schema: public; Owner: grafana
--
...
--
-- Name: resource_blob resource_blob_pkey; Type: CONSTRAINT; Schema: public; Owner: grafana
--
...
--
-- Name: resource_history resource_history_pkey; Type: CONSTRAINT; Schema: public; Owner: grafana
--
...
--
-- Name: resource_migration_log resource_migration_log_pkey; Type: CONSTRAINT; Schema: public; Owner: grafana
--
...
--
-- Name: resource resource_pkey; Type: CONSTRAINT; Schema: public; Owner: grafana
--
...
--
-- Name: user_external_session user_external_session_pkey; Type: CONSTRAINT; Schema: public; Owner: grafana
--
...
--
-- Name: IDX_dashboard_deleted; Type: INDEX; Schema: public; Owner: grafana
--
...
--
-- Name: IDX_dashboard_tag_dashboard_uid; Type: INDEX; Schema: public; Owner: grafana
--
...
--
-- Name: IDX_resource_blob_created; Type: INDEX; Schema: public; Owner: grafana
--
...
--
-- Name: IDX_resource_group_resource; Type: INDEX; Schema: public; Owner: grafana
--
...
--
-- Name: IDX_resource_history_group_resource_resource_version; Type: INDEX; Schema: public; Owner: grafana
--
...
--
-- Name: IDX_resource_history_namespace_group_name; Type: INDEX; Schema: public; Owner: grafana
--
...
--
-- Name: IDX_resource_history_namespace_group_resource_action_version; Type: INDEX; Schema: public; Owner: grafana
--
...
--
-- Name: IDX_resource_history_namespace_group_resource_name_generation; Type: INDEX; Schema: public; Owner: grafana
--
...
--
-- Name: IDX_resource_history_resource_version; Type: INDEX; Schema: public; Owner: grafana
--
...
--
-- Name: IDX_team_member_user_id_org_id; Type: INDEX; Schema: public; Owner: grafana
--
...
--
-- Name: UQE_alert_rule_guid; Type: INDEX; Schema: public; Owner: grafana
--
...
--
-- Name: UQE_alert_rule_state_org_id_rule_uid; Type: INDEX; Schema: public; Owner: grafana
--
...
--
-- Name: UQE_alert_rule_version_rule_guid_version; Type: INDEX; Schema: public; Owner: grafana
--
...
--
-- Name: UQE_alert_rule_version_rule_org_id_rule_uid_rule_guid_version; Type: INDEX; Schema: public; Owner: grafana
--
...
--
-- Name: UQE_cloud_migration_session_uid; Type: INDEX; Schema: public; Owner: grafana
--
...
--
-- Name: UQE_cloud_migration_snapshot_uid; Type: INDEX; Schema: public; Owner: grafana
--
...
--
-- Name: UQE_resource_history_namespace_group_name_version; Type: INDEX; Schema: public; Owner: grafana
--
...
--
-- Name: UQE_resource_namespace_group_resource_name; Type: INDEX; Schema: public; Owner: grafana
--
...
--
-- Name: UQE_resource_version_group_resource; Type: INDEX; Schema: public; Owner: grafana
--

CREATE UNIQUE INDEX "UQE_resource_version_group_resource" ON public.resource_version USING btree ("group", resource);
...
--
-- Name: UQE_star_user_id_dashboard_uid_org_id; Type: INDEX; Schema: public; Owner: grafana
--
...
--
-- Name: UQE_user_role_org_id_user_id_role_id_group_mapping_uid; Type: INDEX; Schema: public; Owner: grafana
--
...
\unrestrict SbeG2HljRLjfkXQZs9XV4WpiYGqHmKMBsaJqW7wAVkbVsCbK5fHDvp0JSP4jdPN
